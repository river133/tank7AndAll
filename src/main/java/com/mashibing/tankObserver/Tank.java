...
public class Tank extends GameObject {
    ...
    public Tank(int x, int y, Dir dir, Group group ) {
        ...
        if(group == Group.GOOD){
            String goodFs = PropertyMgr.getStr("goodFsObserverr");
            try { //配置文件反射诶
...
//        System.out.println(oldY);
    ...
    //观察者设计模式，套用发子弹
    private java.util.List<TankFireObserver> fo = Arrays.asList((TankFireObserver)new TankFireHandler());

    public void handleFireKey() {
        TankFireEvent event = new TankFireEvent(this);
        for (TankFireObserver o : fo) {
