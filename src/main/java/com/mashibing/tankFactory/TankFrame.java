...
import com.mashibing.tankFactory.abstractfactory.*;
...
public class TankFrame extends Frame {
    ...
    public List<BaseTank> tanks = new ArrayList<>();//敌方坦克容器
...
//    GameFactory gf = new DefaultFactory();
    ...
    public static final  int GAME_WIDTH=900,GAME_HEIGHT=800;//窗口宽、高
